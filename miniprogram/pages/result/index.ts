...
function buildVisualGroups(pieces: LevelPiece[]): VisualGroup[] {
  return pieces
...
function buildCookedPieces(result: CalculationResult): LevelPiece[] {
...
function buildSaltPieces(result: CalculationResult): LevelPiece[] {
